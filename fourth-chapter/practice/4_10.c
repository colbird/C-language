...
int getop(char s[]){
	...
	if (strp == 0 || str[strp] == '\0')
		if (new_getline(str,MAXLINE)){
			strp = 0;
		}
		else{
			return EOF;
...
int new_getline (char s[], int max){
	int c, i;
